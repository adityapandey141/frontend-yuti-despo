...
import cardImg4 from "../../assets/images/Home/PAPER STRAWS.webp";
...
export default function Section4() {
  const data = [
    ...
    {
      image: cardImg4,
      heading: "Paper Straws",
      body: "Lightweight, compostable, and made to last through every sip, minus the guilt.",
      svg: (
        <svg
          id="Capa_1"
          enableBackground="new 0 0 593.922 593.922"
        ...
        <div className=" grid grid-cols-1 md:grid-cols-4 gap-4 container  mx-auto  ">
          {data.map((val, index) => (
            ...
            >
              ...
              <div className="grid grid-rows-1 gap-6   mt-[10px] iconbox px-5 md:px-6 pb-5 md:pb-5">
